...
oferta_academica = {
    ...
    "⚖️ Taller de Ética": [{"profesor": "Emma Julia Velarde Sanchez", "salon": "B-1", "horario": [(d,7,8) for d in range(4)], "id":"TE1"}, {"profesor": "Emma Julia Velarde Sanchez", "salon": "B-1", "horario": [(d,8,9) for d in range(4)], "id":"TE2"}, {"profesor": "Maria Del Refugio Quijano Urbano", "salon": "B-2", "horario": [(d,7,8) for d in range(4)], "id":"TE3"}, {"profesor": "Maria Del Refugio Quijano Urbano", "salon": "B-2", "horario": [(d,9,10) for d in range(4)], "id":"TE4"}, {"profesor": "Claudia Enriqueta Cárdenas Aguirre", "salon": "B-3", "horario": [(d,9,10) for d in range(4)], "id":"TE5"}, {"profesor": "Juana María Espinoza Rocha", "salon": "B-4", "horario": [(d,9,10) for d in range(4)], "id":"TE6"}, {"profesor": "Juana María Espinoza Rocha", "salon": "B-4", "horario": [(d,10,11) for d in range(4)], "id":"TE7"}, {"profesor": "Juana María Espinoza Rocha", "salon": "B-4", "horario": [(d,11,12) for d in range(4)], "id":"TE8"}, {"profesor": "Juana María Espinoza Rocha", "salon": "B-4", "horario": [(d,13,14) for d in range(4)], "id":"TE9"}, {"profesor": "Ana Laura Peña Cruz", "salon": "B-5", "horario": [(d,10,11) for d in range(4)], "id":"TE10"}, {"profesor": "Guadalupe Del Socorro Peña Cruz", "salon": "B-6", "horario": [(d,10,11) for d in range(4)], "id":"TE11"}, {"profesor": "Guadalupe Del Socorro Peña Cruz", "salon": "B-6", "horario": [(d,12,13) for d in range(4)], "id":"TE12"}, {"profesor": "Sara Griselda Reyes Patiño", "salon": "B-7", "horario": [(d,11,12) for d in range(4)], "id":"TE13"}, {"profesor": "Martin Mireles Contreras", "salon": "B-8", "horario": [(d,15,16) for d in range(4)], "id":"TE14"}, {"profesor": "Martin Mireles Contreras", "salon": "B-8", "horario": [(d,16,17) for d in range(4)], "id":"TE15"}, {"profesor": "Verónica Arlaine Barajas Salazar", "salon": "B-9", "horario": [(d,17,18) for d in range(4)], "id":"TE16"}, {"profesor": "Verónica Arlaine Barajas Salazar", "salon": "B-9", "horario": [(d,18,19) for d in range(4)], "id":"TE17"}, {"profesor": "Marcela Perales Moreno", "salon": "B-10", "horario": [(d,18,19) for d in range(4)], "id":"TE18"}, {"profesor": "Marcela Perales Moreno", "salon": "B-10", "horario": [(d,20,21) for d in range(4)], "id":"TE19"}, {"profesor": "Jesus Esquivel Alonso", "salon": "B-11", "horario": [(d,18,19) for d in range(4)], "id":"TE20"}, {"profesor": "Carlos Benito Arriaga Aguilar", "salon": "B-12", "horario": [(d,20,21) for d in range(4)], "id":"TE21"}],
    "💻 Dibujo Asistido por Computadora": [{"profesor": "Cynthia Maricela Calzoncit Carranza", "salon": "C-1", "horario": [(d,10,11) for d in range(4)], "id":"D1"}, {"profesor": "Laura Villegas Leza", "salon": "C-2", "horario": [(d,12,13) for d in range(4)], "id":"D2"}, {"profesor": "Laura Villegas Leza", "salon": "C-2", "horario": [(d,13,14) for d in range(4)], "id":"D3"}, {"profesor": "Alejandro Ayala Ramos", "salon": "C-3", "horario": [(d,14,15) for d in range(4)], "id":"D4"}, {"profesor": "Alejandro Ayala Ramos", "salon": "C-3", "horario": [(d,15,16) for d in range(4)], "id":"D5"}],
    "📏 Metrología y Normalización": [{"profesor": "Juan Francisco Tovar Epifanio", "salon": "D-1", "horario": [(d,7,8) for d in range(4)], "id":"M1"}, {"profesor": "Juan Francisco Tovar Epifanio", "salon": "D-1", "horario": [(d,12,13) for d in range(4)], "id":"M2"}, {"profesor": "Pedro Lopez Martinez", "salon": "D-2", "horario": [(d,10,11) for d in range(4)], "id":"M3"}, {"profesor": "Eustaquio Silva Torres", "salon": "D-3", "horario": [(d,12,13) for d in range(4)], "id":"M4"}, {"profesor": "Eustaquio Silva Torres", "salon": "D-3", "horario": [(d,14,15) for d in range(4)], "id":"M5"}, {"profesor": "Carlos Eduardo Resendiz Galindo", "salon": "D-4", "horario": [(d,16,17) for d in range(4)], "id":"M6"}, {"profesor": "Luis Alejandro Gonzalez Valdez", "salon": "D-5", "horario": [(d,18,19) for d in range(4)], "id":"M7"}],
    "🔎 Fundamentos de Investigación": [{"profesor": "Cristobal Enrique Yeverino Martinez", "salon": "E-1", "horario": [(d,10,11) for d in range(4)], "id":"F1"}, {"profesor": "Cristobal Enrique Yeverino Martinez", "salon": "E-1", "horario": [(d,11,12) for d in range(4)], "id":"F2"}, {"profesor": "Leticia Urbina Valdes", "salon": "E-2", "horario": [(d,12,13) for d in range(4)], "id":"F3"}, {"profesor": "Leticia Urbina Valdes", "salon": "E-2", "horario": [(d,13,14) for d in range(4)], "id":"F4"}],
    # SEMESTRE 2
    "∫ Cálculo Integral": [{"profesor": "Víctor Arturo Ferniza Pérez", "salon": "F-1", "horario": [(d,7,8) for d in range(5)], "id":"CI1"}, {"profesor": "Víctor Arturo Ferniza Pérez", "salon": "F-1", "horario": [(d,8,9) for d in range(5)], "id":"CI2"}, {"profesor": "Víctor Arturo Ferniza Pérez", "salon": "F-1", "horario": [(d,9,10) for d in range(5)], "id":"CI3"}, {"profesor": "Felipe De Jesus Mendoza Morales", "salon": "F-2", "horario": [(d,7,8) for d in range(5)], "id":"CI4"}, {"profesor": "Felipe De Jesus Mendoza Morales", "salon": "F-2", "horario": [(d,8,9) for d in range(5)], "id":"CI5"}, {"profesor": "Felipe De Jesus Mendoza Morales", "salon": "F-2", "horario": [(d,9,10) for d in range(5)], "id":"CI6"}, {"profesor": "Felipe De Jesus Mendoza Morales", "salon": "F-2", "horario": [(d,10,11) for d in range(5)], "id":"CI7"}, {"profesor": "Silvia Polendo Luis", "salon": "F-3", "horario": [(d,7,8) for d in range(5)], "id":"CI8"}, {"profesor": "Silvia Polendo Luis", "salon": "F-3", "horario": [(d,8,9) for d in range(5)], "id":"CI9"}, {"profesor": "Silvia Polendo Luis", "salon": "F-3", "horario": [(d,9,10) for d in range(5)], "id":"CI10"}, {"profesor": "Silvia Polendo Luis", "salon": "F-3", "horario": [(d,10,11) for d in range(5)], "id":"CI11"}, {"profesor": "Silvia Polendo Luis", "salon": "F-3", "horario": [(d,11,12) for d in range(5)], "id":"CI12"}, {"profesor": "Narda Lucely Reyes Acosta", "salon": "F-4", "horario": [(d,8,9) for d in range(5)], "id":"CI13"}, {"profesor": "Narda Lucely Reyes Acosta", "salon": "F-4", "horario": [(d,11,12) for d in range(5)], "id":"CI14"}, {"profesor": "Narda Lucely Reyes Acosta", "salon": "F-4", "horario": [(d,12,13) for d in range(5)], "id":"CI15"}, {"profesor": "J. Santos Valdez Perez", "salon": "F-5", "horario": [(d,8,9) for d in range(5)], "id":"CI16"}, {"profesor": "J. Santos Valdez Perez", "salon": "F-5", "horario": [(d,9,10) for d in range(5)], "id":"CI17"}, {"profesor": "J. Santos Valdez Perez", "salon": "F-5", "horario": [(d,10,11) for d in range(5)], "id":"CI18"}, {"profesor": "J. Santos Valdez Perez", "salon": "F-5", "horario": [(d,11,12) for d in range(5)], "id":"CI19"}, {"profesor": "Fabio López Campos", "salon": "F-6", "horario": [(d,10,11) for d in range(5)], "id":"CI20"}, {"profesor": "Fabio López Campos", "salon": "F-6", "horario": [(d,11,12) for d in range(5)], "id":"CI21"}, {"profesor": "Fabio López Campos", "salon": "F-6", "horario": [(d,12,13) for d in range(5)], "id":"CI22"}, {"profesor": "Fabio López Campos", "salon": "F-6", "horario": [(d,13,14) for d in range(5)], "id":"CI23"}, {"profesor": "Erwin Rommel Cerda Leon", "salon": "F-7", "horario": [(d,12,13) for d in range(5)], "id":"CI24"}, {"profesor": "Erwin Rommel Cerda Leon", "salon": "F-7", "horario": [(d,17,18) for d in range(5)], "id":"CI25"}, {"profesor": "Luis Manuel Ferniza Pérez", "salon": "F-8", "horario": [(d,12,13) for d in range(5)], "id":"CI26"}, {"profesor": "Luis Manuel Ferniza Pérez", "salon": "F-8", "horario": [(d,13,14) for d in range(5)], "id":"CI27"}, {"profesor": "Ignacio Dávila Ríos", "salon": "F-9", "horario": [(d,16,17) for d in range(5)], "id":"CI28"}, {"profesor": "Ignacio Dávila Ríos", "salon": "F-9", "horario": [(d,19,20) for d in range(5)], "id":"CI29"}, {"profesor": "Miguel Angel Flores Villa", "salon": "F-10", "horario": [(d,16,17) for d in range(5)], "id":"CI30"}, {"profesor": "Miguel Angel Flores Villa", "salon": "F-10", "horario": [(d,18,19) for d in range(5)], "id":"CI31"}, {"profesor": "Miguel Angel Flores Villa", "salon": "F-10", "horario": [(d,21,22) for d in range(5)], "id":"CI32"}],
    "🧮 Álgebra Lineal": [{"profesor": "Juan Angel Sánchez Espinoza", "salon": "G-1", "horario": [(d,7,8) for d in range(5)], "id":"AL1"}, {"profesor": "Juan Angel Sánchez Espinoza", "salon": "G-1", "horario": [(d,8,9) for d in range(5)], "id":"AL2"}, {"profesor": "Juan Angel Sánchez Espinoza", "salon": "G-1", "horario": [(d,9,10) for d in range(5)], "id":"AL3"}, {"profesor": "Juan Angel Sánchez Espinoza", "salon": "G-1", "horario": [(d,10,11) for d in range(5)], "id":"AL4"}, {"profesor": "Juan Francisco Benavides Ramos", "salon": "G-2", "horario": [(d,7,8) for d in range(5)], "id":"AL5"}, {"profesor": "Juan Francisco Benavides Ramos", "salon": "G-2", "horario": [(d,8,9) for d in range(5)], "id":"AL6"}, {"profesor": "Juan Francisco Benavides Ramos", "salon": "G-2", "horario": [(d,9,10) for d in range(5)], "id":"AL7"}, {"profesor": "Romina Denisse Sanchez", "salon": "G-3", "horario": [(d,7,8) for d in range(5)], "id":"AL8"}, {"profesor": "Romina Denisse Sanchez", "salon": "G-3", "horario": [(d,9,10) for d in range(5)], "id":"AL9"}, {"profesor": "Juan Antonio Ruiz Muñiz", "salon": "G-4", "horario": [(d,9,10) for d in range(5)], "id":"AL10"}, {"profesor": "Juan Antonio Ruiz Muñiz", "salon": "G-4", "horario": [(d,12,13) for d in range(5)], "id":"AL11"}, {"profesor": "Jorge Alberto Ruiz Muñiz", "salon": "G-5", "horario": [(d,11,12) for d in range(5)], "id":"AL12"}, {"profesor": "Celina Gaytan Tanguma", "salon": "G-6", "horario": [(d,12,13) for d in range(5)], "id":"AL13"}, {"profesor": "Celina Gaytan Tanguma", "salon": "G-6", "horario": [(d,13,14) for d in range(5)], "id":"AL14"}, {"profesor": "Celina Gaytan Tanguma", "salon": "G-6", "horario": [(d,14,15) for d in range(5)], "id":"AL15"}, {"profesor": "Ignacio Dávila Ríos", "salon": "G-7", "horario": [(d,18,19) for d in range(5)], "id":"AL16"}, {"profesor": "Veronica Martinez Villafuerte", "salon": "G-8", "horario": [(d,16,17) for d in range(5)], "id":"AL17"}, {"profesor": "Justino Barrales Montes", "salon": "G-9", "horario": [(d,16,17) for d in range(5)], "id":"AL18"}, {"profesor": "Justino Barrales Montes", "salon": "G-9", "horario": [(d,17,18) for d in range(5)], "id":"AL19"}, {"profesor": "Justino Barrales Montes", "salon": "G-9", "horario": [(d,18,19) for d in range(5)], "id":"AL20"}],
    "🧱 Ciencia e Ingeniería de Materiales": [{"profesor": "Dolores García De León", "salon": "H-1", "horario": [(d,10,11) for d in range(5)], "id":"CIM1"}, {"profesor": "Dolores García De León", "salon": "H-1", "horario": [(d,12,13) for d in range(5)], "id":"CIM2"}, {"profesor": "Luis Alberto Terrazas Ramos", "salon": "H-2", "horario": [(d,10,11) for d in range(5)], "id":"CIM3"}, {"profesor": "Luis Alberto Terrazas Ramos", "salon": "H-2", "horario": [(d,11,12) for d in range(5)], "id":"CIM4"}, {"profesor": "Luis Alberto Terrazas Ramos", "salon": "H-2", "horario": [(d,14,15) for d in range(5)], "id":"CIM5"}, {"profesor": "Raquel Guadalupe Ruiz Moreno", "salon": "H-3", "horario": [(d,10,11) for d in range(5)], "id":"CIM6"}, {"profesor": "Andrea Sanchez Arroyo", "salon": "H-4", "horario": [(d,15,16) for d in range(5)], "id":"CIM7"}, {"profesor": "Socorro Del Carmen Espinoza Cardona", "salon": "H-5", "horario": [(d,16,17) for d in range(5)], "id":"CIM8"}, {"profesor": "Socorro Del Carmen Espinoza Cardona", "salon": "H-5", "horario": [(d,18,19) for d in range(5)], "id":"CIM9"}],
    "💾 Programación Básica": [{"profesor": "Francisco Javier De Leon Macias", "salon": "I-1", "horario": [(d,7,8) for d in range(5)], "id":"PB1"}, {"profesor": "Francisco Javier De Leon Macias", "salon": "I-1", "horario": [(d,8,9) for d in range(5)], "id":"PB2"}, {"profesor": "Leticia Castillo Hernández", "salon": "I-2", "horario": [(d,9,10) for d in range(5)], "id":"PB3"}, {"profesor": "Leticia Castillo Hernández", "salon": "I-2", "horario": [(d,13,14) for d in range(5)], "id":"PB4"}, {"profesor": "Leticia Castillo Hernández", "salon": "I-2", "horario": [(d,14,15) for d in range(5)], "id":"PB5"}, {"profesor": "Arturo Alejandro Domínguez Martínez", "salon": "I-3", "horario": [(d,11,12) for d in range(5)], "id":"PB6"}, {"profesor": "Hector Garcia Hernandez", "salon": "I-4", "horario": [(d,15,16) for d in range(5)], "id":"PB7"}, {"profesor": "Garcia Hernandez Hector", "salon": "I-4", "horario": [(d,16,17) for d in range(5)], "id":"PB8"}, {"profesor": "Mario Alberto Jáuregui Sánchez", "salon": "I-5", "horario": [(d,17,18) for d in range(5)], "id":"PB9"}, {"profesor": "Mario Alberto Jáuregui Sánchez", "salon": "I-5", "horario": [(d,18,19) for d in range(5)], "id":"PB10"}],
    "📊 Estadística y Control de Calidad": [{"profesor": "Georgina Solis Rodriguez", "salon": "J-1", "horario": [(d,8,9) for d in range(4)], "id":"ECC1"}, {"profesor": "Georgina Solis Rodriguez", "salon": "J-1", "horario": [(d,9,10) for d in range(4)], "id":"ECC2"}, {"profesor": "Federico Zertuche Luis", "salon": "J-2", "horario": [(d,10,11) for d in range(4)], "id":"ECC3"}, {"profesor": "Jose Sirahuen Velez Name", "salon": "J-3", "horario": [(d,11,12) for d in range(4)], "id":"ECC4"}, {"profesor": "Jose Sirahuen Velez Name", "salon": "J-3", "horario": [(d,13,14) for d in range(4)], "id":"ECC5"}, {"profesor": "Jose Sirahuen Velez Name", "salon": "J-3", "horario": [(d,14,15) for d in range(4)], "id":"ECC6"}, {"profesor": "Irma Violeta García Pimentel", "salon": "J-4", "horario": [(d,11,12) for d in range(4)], "id":"ECC7"}, {"profesor": "Irma Violeta García Pimentel", "salon": "J-4", "horario": [(d,12,13) for d in range(4)], "id":"ECC8"}, {"profesor": "Alma Patricia Lopez De Leon", "salon": "J-5", "horario": [(d,16,17) for d in range(4)], "id":"ECC9"}, {"profesor": "Alma Patricia Lopez De Leon", "salon": "J-5", "horario": [(d,18,19) for d in range(4)], "id":"ECC10"}],
    "💰 Administración y Contabilidad": [{"profesor": "Dalia Veronica Aguillon Padilla", "salon": "K-1", "horario": [(d,10,11) for d in range(4)], "id":"AC1"}, {"profesor": "Patricia Alejandra Fernandez Rangel", "salon": "K-2", "horario": [(d,11,12) for d in range(4)], "id":"AC2"}, {"profesor": "Patricia Alejandra Fernandez Rangel", "salon": "K-2", "horario": [(d,12,13) for d in range(4)], "id":"AC3"}, {"profesor": "Martin Rodriguez Contreras", "salon": "K-3", "horario": [(d,13,14) for d in range(4)], "id":"AC4"}, {"profesor": "Martin Rodriguez Contreras", "salon": "K-3", "horario": [(d,14,15) for d in range(4)], "id":"AC5"}, {"profesor": "Martin Rodriguez Contreras", "salon": "K-3", "horario": [(d,15,16) for d in range(4)], "id":"AC6"}, {"profesor": "Martin Rodriguez Contreras", "salon": "K-3", "horario": [(d,16,17) for d in range(4)], "id":"AC7"}, {"profesor": "Martin Rodriguez Contreras", "salon": "K-3", "horario": [(d,17,18) for d in range(4)], "id":"AC8"}, {"profesor": "Francisco Alberto Galindo González", "salon": "K-4", "horario": [(d,17,18) for d in range(4)], "id":"AC9"}, {"profesor": "Edgar Felipe Vazquez Siller", "salon": "K-5", "horario": [(d,19,20) for d in range(4)], "id":"AC10"}],
    # SEMESTRE 3
    "↗️ Cálculo Vectorial": [{"profesor": "Lucia Marisol Valdes Gonzalez", "salon": "L-1", "horario": [(d,8,9) for d in range(5)], "id":"CV1"}, {"profesor": "Lucia Marisol Valdes Gonzalez", "salon": "L-1", "horario": [(d,9,10) for d in range(5)], "id":"CV2"}, {"profesor": "Silvia Deyanira Rodriguez Luna", "salon": "L-2", "horario": [(d,9,10) for d in range(5)], "id":"CV3"}, {"profesor": "Silvia Deyanira Rodriguez Luna", "salon": "L-2", "horario": [(d,10,11) for d in range(5)], "id":"CV4"}, {"profesor": "Jose Ignacio Garcia Alvarez", "salon": "L-3", "horario": [(d,13,14) for d in range(5)], "id":"CV5"}, {"profesor": "Jose Ignacio Garcia Alvarez", "salon": "L-3", "horario": [(d,14,15) for d in range(5)], "id":"CV6"}, {"profesor": "Jose Ignacio Garcia Alvarez", "salon": "L-3", "horario": [(d,15,16) for d in range(5)], "id":"CV7"}, {"profesor": "Jose Ignacio Garcia Alvarez", "salon": "L-3", "horario": [(d,16,17) for d in range(5)], "id":"CV8"}, {"profesor": "Rene Sanchez Ramos", "salon": "L-4", "horario": [(d,13,14) for d in range(5)], "id":"CV9"}, {"profesor": "Rene Sanchez Ramos", "salon": "L-4", "horario": [(d,14,15) for d in range(5)], "id":"CV10"}, {"profesor": "Alicia Guadalupe Del Bosque Martínez", "salon": "L-5", "horario": [(d,14,15) for d in range(5)], "id":"CV11"}, {"profesor": "Gloria Estela Martinez Montemayor", "salon": "L-6", "horario": [(d,16,17) for d in range(5)], "id":"CV12"}, {"profesor": "Miguel Angel Flores Villa", "salon": "L-7", "horario": [(d,19,20) for d in range(5)], "id":"CV13"}],
    "🔨 Procesos de Fabricación": [{"profesor": "Efrain Almanza Casas", "salon": "M-1", "horario": [(d,8,9) for d in range(4)], "id":"PF1"}, {"profesor": "Efrain Almanza Casas", "salon": "M-1", "horario": [(d,9,10) for d in range(4)], "id":"PF2"}, {"profesor": "Efrain Almanza Casas", "salon": "M-1", "horario": [(d,13,14) for d in range(4)], "id":"PF3"}, {"profesor": "Anabel Azucena Hernandez Cortes", "salon": "M-2", "horario": [(d,13,14) for d in range(4)], "id":"PF4"}, {"profesor": "Arnoldo Solis Covarrubias", "salon": "M-3", "horario": [(d,16,17) for d in range(4)], "id":"PF5"}, {"profesor": "Arnoldo Solis Covarrubias", "salon": "M-3", "horario": [(d,19,20) for d in range(4)], "id":"PF6"}],
    "⚡ Electromagnetismo": [{"profesor": "Christian Aldaco González", "salon": "N-1", "horario": [(d,9,10) for d in range(5)], "id":"E1"}, {"profesor": "Christian Aldaco González", "salon": "N-1", "horario": [(d,10,11) for d in range(5)], "id":"E2"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,14,15) for d in range(5)], "id":"E3"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,15,16) for d in range(5)], "id":"E4"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,16,17) for d in range(5)], "id":"E5"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,17,18) for d in range(5)], "id":"E6"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,18,19) for d in range(5)], "id":"E7"}, {"profesor": "Benjamin Arellano Orozco", "salon": "N-2", "horario": [(d,19,20) for d in range(5)], "id":"E8"}],
    "🏗️ Estática": [{"profesor": "Jorge Oyervides Valdez", "salon": "O-1", "horario": [(d,8,9) for d in range(4)], "id":"ES1"}, {"profesor": "Jorge Oyervides Valdez", "salon": "O-1", "horario": [(d,9,10) for d in range(4)], "id":"ES2"}, {"profesor": "Jorge Oyervides Valdez", "salon": "O-1", "horario": [(d,12,13) for d in range(4)], "id":"ES3"}, {"profesor": "Jorge Oyervides Valdez", "salon": "O-1", "horario": [(d,17,18) for d in range(4)], "id":"ES4"}, {"profesor": "Jorge Oyervides Valdez", "salon": "O-1", "horario": [(d,18,19) for d in range(4)], "id":"ES5"}, {"profesor": "Leticia Urbina Valdes", "salon": "O-2", "horario": [(d,10,11) for d in range(4)], "id":"ES6"}, {"profesor": "Leticia Urbina Valdes", "salon": "O-2", "horario": [(d,11,12) for d in range(4)], "id":"ES7"}],
    "🔢 Métodos Numéricos": [{"profesor": "Gustavo Lopez Guarin", "salon": "P-1", "horario": [(d,15,16) for d in range(4)], "id":"MN1"}, {"profesor": "Justino Barrales Montes", "salon": "P-2", "horario": [(d,15,16) for d in range(4)], "id":"MN2"}, {"profesor": "Justino Barrales Montes", "salon": "P-2", "horario": [(d,19,20) for d in range(4)], "id":"MN3"}, {"profesor": "Justino Barrales Montes", "salon": "P-2", "horario": [(d,20,21) for d in range(4)], "id":"MN4"}, {"profesor": "Justino Barrales Montes", "salon": "P-2", "horario": [(d,21,22) for d in range(4)], "id":"MN5"}],
    "🌱 Desarrollo Sustentable": [{"profesor": "Fernando Miguel Viesca Farias", "salon": "Q-1", "horario": [(d,7,8) for d in range(5)], "id":"DS1"}, {"profesor": "Virginia Flores Gaytan", "salon": "Q-2", "horario": [(d,8,9) for d in range(5)], "id":"DS2"}, {"profesor": "Virginia Flores Gaytan", "salon": "Q-2", "horario": [(d,9,10) for d in range(5)], "id":"DS3"}, {"profesor": "Virginia Flores Gaytan", "salon": "Q-2", "horario": [(d,11,12) for d in range(5)], "id":"DS4"}, {"profesor": "Virginia Flores Gaytan", "salon": "Q-2", "horario": [(d,12,13) for d in range(5)], "id":"DS5"}, {"profesor": "Aida Isolda Fernández De La Cerda", "salon": "Q-3", "horario": [(d,8,9) for d in range(5)], "id":"DS6"}, {"profesor": "Aida Isolda Fernández De La Cerda", "salon": "Q-3", "horario": [(d,9,10) for d in range(5)], "id":"DS7"}, {"profesor": "Marcela Guadalupe Moreno Padilla", "salon": "Q-4", "horario": [(d,9,10) for d in range(5)], "id":"DS8"}, {"profesor": "Marcela Guadalupe Moreno Padilla", "salon": "Q-4", "horario": [(d,10,11) for d in range(5)], "id":"DS9"}, {"profesor": "Marcela Guadalupe Moreno Padilla", "salon": "Q-4", "horario": [(d,13,14) for d in range(5)], "id":"DS10"}, {"profesor": "Alicia Orta Mendoza", "salon": "Q-5", "horario": [(d,11,12) for d in range(5)], "id":"DS11"}, {"profesor": "Alicia Orta Mendoza", "salon": "Q-5", "horario": [(d,12,13) for d in range(5)], "id":"DS12"}, {"profesor": "Alicia Orta Mendoza", "salon": "Q-5", "horario": [(d,15,16) for d in range(5)], "id":"DS13"}, {"profesor": "Alicia Orta Mendoza", "salon": "Q-5", "horario": [(d,16,17) for d in range(5)], "id":"DS14"}, {"profesor": "Pedro Angel Gonzalez Barrera", "salon": "Q-6", "horario": [(d,11,12) for d in range(5)], "id":"DS15"}, {"profesor": "Pedro Angel Gonzalez Barrera", "salon": "Q-6", "horario": [(d,12,13) for d in range(5)], "id":"DS16"}, {"profesor": "Pedro Angel Gonzalez Barrera", "salon": "Q-6", "horario": [(d,13,14) for d in range(5)], "id":"DS17"}, {"profesor": "Alexeyevich Flores Sanchez", "salon": "Q-7", "horario": [(d,11,12) for d in range(5)], "id":"DS18"}, {"profesor": "Alexeyevich Flores Sanchez", "salon": "Q-7", "horario": [(d,12,13) for d in range(5)], "id":"DS19"}, {"profesor": "Manuel Rodarte Carrillo", "salon": "Q-8", "horario": [(d,13,14) for d in range(5)], "id":"DS20"}, {"profesor": "Manuel Rodarte Carrillo", "salon": "Q-8", "horario": [(d,14,15) for d in range(5)], "id":"DS21"}, {"profesor": "Manuel Rodarte Carrillo", "salon": "Q-8", "horario": [(d,17,18) for d in range(5)], "id":"DS22"}, {"profesor": "Manuel Rodarte Carrillo", "salon": "Q-8", "horario": [(d,18,19) for d in range(5)], "id":"DS23"}, {"profesor": "Juan Carlos Loyola Licea", "salon": "Q-9", "horario": [(d,15,16) for d in range(5)], "id":"DS24"}, {"profesor": "Mario Alberto De La Rosa Cepeda", "salon": "Q-10", "horario": [(d,15,16) for d in range(5)], "id":"DS25"}, {"profesor": "Mario Alberto De La Rosa Cepeda", "salon": "Q-10", "horario": [(d,16,17) for d in range(5)], "id":"DS26"}, {"profesor": "Mario Alberto De La Rosa Cepeda", "salon": "Q-10", "horario": [(d,17,18) for d in range(5)], "id":"DS27"}, {"profesor": "Mario Alberto De La Rosa Cepeda", "salon": "Q-10", "horario": [(d,18,19) for d in range(5)], "id":"DS28"}, {"profesor": "Ramon Andres Durón Ibarra", "salon": "Q-11", "horario": [(d,16,17) for d in range(5)], "id":"DS29"}, {"profesor": "Veronica Amaro Hernandez", "salon": "Q-12", "horario": [(d,17,18) for d in range(5)], "id":"DS30"}, {"profesor": "Veronica Amaro Hernandez", "salon": "Q-12", "horario": [(d,18,19) for d in range(5)], "id":"DS31"}, {"profesor": "Rene Martinez Perez", "salon": "Q-13", "horario": [(d,18,19) for d in range(5)], "id":"DS32"}, {"profesor": "Rene Martinez Perez", "salon": "Q-13", "horario": [(d,19,20) for d in range(5)], "id":"DS33"}],
    # SEMESTRE 4
    "📉 Ecuaciones Diferenciales": [{"profesor": "Ismael Luevano Martinez", "salon": "R-1", "horario": [(d,8,9) for d in range(5)], "id":"ED1"}, {"profesor": "Romina Denisse Sanchez", "salon": "R-2", "horario": [(d,8,9) for d in range(5)], "id":"ED2"}, {"profesor": "Romina Denisse Sanchez", "salon": "R-2", "horario": [(d,10,11) for d in range(5)], "id":"ED3"}, {"profesor": "César Iván Cantú", "salon": "R-3", "horario": [(d,9,10) for d in range(5)], "id":"ED4"}, {"profesor": "Lucia Marisol Valdes Gonzalez", "salon": "R-4", "horario": [(d,10,11) for d in range(5)], "id":"ED5"}, {"profesor": "Lucia Marisol Valdes Gonzalez", "salon": "R-4", "horario": [(d,11,12) for d in range(5)], "id":"ED6"}, {"profesor": "Olivia García Calvillo", "salon": "R-5", "horario": [(d,10,11) for d in range(5)], "id":"ED7"}, {"profesor": "Olivia García Calvillo", "salon": "R-5", "horario": [(d,11,12) for d in range(5)], "id":"ED8"}, {"profesor": "Olivia García Calvillo", "salon": "R-5", "horario": [(d,13,14) for d in range(5)], "id":"ED9"}, {"profesor": "Olivia García Calvillo", "salon": "R-5", "horario": [(d,14,15) for d in range(5)], "id":"ED10"}, {"profesor": "Jesus Cantú Perez", "salon": "R-6", "horario": [(d,11,12) for d in range(5)], "id":"ED11"}, {"profesor": "Jesus Cantú Perez", "salon": "R-6", "horario": [(d,13,14) for d in range(5)], "id":"ED12"}, {"profesor": "Alicia Guadalupe Del Bosque Martínez", "salon": "R-7", "horario": [(d,13,14) for d in range(5)], "id":"ED13"}, {"profesor": "Jorge Alberto Ramos Oliveira", "salon": "R-8", "horario": [(d,17,18) for d in range(5)], "id":"ED14"}],
    "🔥 Fundamentos de Termodinámica": [{"profesor": "Luis Miguel Veloz Pachicano", "salon": "S-1", "horario": [(d,7,8) for d in range(4)], "id":"FT1"}, {"profesor": "Luis Miguel Veloz Pachicano", "salon": "S-1", "horario": [(d,11,12) for d in range(4)], "id":"FT2"}, {"profesor": "Elena Guadalupe Luques Lopez", "salon": "S-2", "horario": [(d,8,9) for d in range(4)], "id":"FT3"}, {"profesor": "Elena Guadalupe Luques Lopez", "salon": "S-2", "horario": [(d,13,14) for d in range(4)], "id":"FT4"}, {"profesor": "Erendira Del Rocio Gamon Perales", "salon": "S-3", "horario": [(d,10,11) for d in range(4)], "id":"FT5"}, {"profesor": "Erendira Del Rocio Gamon Perales", "salon": "S-3", "horario": [(d,12,13) for d in range(4)], "id":"FT6"}, {"profesor": "Edgar Omar Resendiz Flores", "salon": "S-4", "horario": [(d,12,13) for d in range(4)], "id":"FT7"}, {"profesor": "Massiel Cristina Cisneros Morales", "salon": "S-5", "horario": [(d,15,16) for d in range(4)], "id":"FT8"}, {"profesor": "Massiel Cristina Cisneros Morales", "salon": "S-5", "horario": [(d,18,19) for d in range(4)], "id":"FT9"}],
    ...
    "🔗 Mecanismos": [{"profesor": "Cipriano Alvarado González", "salon": "Z-1", "horario": [(d,9,10) for d in range(5)], "id":"MEC1"}, {"profesor": "Julian Javier Hernandez De La Rosa", "salon": "Z-2", "horario": [(d,11,12) for d in range(5)], "id":"MEC2"}, {"profesor": "Julian Javier Hernandez De La Rosa", "salon": "Z-2", "horario": [(d,12,13) for d in range(5)], "id":"MEC3"}, {"profesor": "Julian Javier Hernandez De La Rosa", "salon": "Z-2", "horario": [(d,15,16) for d in range(5)], "id":"MEC4"}],
    "💧 Análisis de Fluidos": [{"profesor": "Edgar Benito Martinez Mercado", "salon": "AA-1", "horario": [(d,7,8) for d in range(4)], "id":"AF1"}, {"profesor": "Edgar Benito Martinez Mercado", "salon": "AA-1", "horario": [(d,11,12) for d in range(4)], "id":"AF2"}, {"profesor": "Edgar Benito Martinez Mercado", "salon": "AA-1", "horario": [(d,13,14) for d in range(4)], "id":"AF3"}, {"profesor": "Luis Alejandro Gonzalez Valdez", "salon": "AA-2", "horario": [(d,16,17) for d in range(4)], "id":"AF4"}, {"profesor": "Luis Alejandro Gonzalez Valdez", "salon": "AA-2", "horario": [(d,19,20) for d in range(4)], "id":"AF5"}, {"profesor": "Ignacio Javier González Ordaz", "salon": "AA-3", "horario": [(d,18,19) for d in range(4)], "id":"AF6"}, {"profesor": "Ignacio Javier González Ordaz", "salon": "AA-3", "horario": [(d,19,20) for d in range(4)], "id":"AF7"}],
    "📑 Taller de Investigación II": [{"profesor": "Ada Karina Velarde Sanchez", "salon": "BB-1", "horario": [(d,7,8) for d in range(4)], "id":"TI2_1"}, {"profesor": "Juana Maria Dueñaz Reyes", "salon": "BB-2", "horario": [(d,8,9) for d in range(4)], "id":"TI2_2"}, {"profesor": "Ma. Elida Zavala Torres", "salon": "BB-3", "horario": [(d,17,18) for d in range(4)], "id":"TI2_3"}, {"profesor": "Ma. Elida Zavala Torres", "salon": "BB-3", "horario": [(d,18,19) for d in range(4)], "id":"TI2_4"}],
    "💻 Programación Avanzada": [{"profesor": "Juan Gilberto Navarro Rodriguez", "salon": "CC-1", "horario": [(0,7,8),(1,7,8),(2,7,8),(3,7,8),(4,7,9)], "id":"PA1"}, {"profesor": "Juan Gilberto Navarro Rodriguez", "salon": "CC-1", "horario": [(0,13,14),(1,13,14),(2,13,14),(3,13,14),(4,12,14)], "id":"PA2"}, {"profesor": "Olga Lidia Vidal Vazquez", "salon": "CC-2", "horario": [(0,8,9),(1,8,9),(2,8,9),(3,8,9),(4,8,10)], "id":"PA3"}, {"profesor": "Olga Lidia Vidal Vazquez", "salon": "CC-2", "horario": [(0,14,15),(1,14,15),(2,14,15),(3,14,15),(4,13,15)], "id":"PA4"}, {"profesor": "Yolanda Mexicano Reyes", "salon": "CC-3", "horario": [(0,9,10),(1,9,10),(2,9,10),(3,9,10),(4,8,10)], "id":"PA5"}, {"profesor": "Yolanda Mexicano Reyes", "salon": "CC-3", "horario": [(0,10,11),(1,10,11),(2,10,11),(3,10,11),(4,10,12)], "id":"PA6"}, {"profesor": "Yolanda Mexicano Reyes", "salon": "CC-3", "horario": [(0,12,13),(1,12,13),(2,12,13),(3,12,13),(4,12,14)], "id":"PA7"}, {"profesor": "Martha Patricia Piña Villanueva", "salon": "CC-4", "horario": [(0,11,12),(1,11,12),(2,11,12),(3,11,12),(4,10,12)], "id":"PA8"}, {"profesor": "Martha Patricia Piña Villanueva", "salon": "CC-4", "horario": [(0,12,13),(1,12,13),(2,12,13),(3,12,13),(4,12,14)], "id":"PA9"}, {"profesor": "Alfredo Salazar Garcia", "salon": "CC-5", "horario": [(0,17,18),(1,17,18),(2,17,18),(3,17,18),(4,16,18)], "id":"PA10"}],
    # SEMESTRE 6
    "⚡ Electrónica de Potencia Aplicada": [{"profesor": "Iván De Jesús Epifanio López", "salon": "DD-1", "horario": [(0,13,14),(1,13,14),(2,13,14),(3,13,14),(4,13,15)], "id":"EPA1"}, {"profesor": "Alejandro Martínez Hernández", "salon": "DD-2", "horario": [(0,16,17),(1,16,17),(2,16,17),(3,16,17),(4,16,18)], "id":"EPA2"}],
    "🌡️ Instrumentación": [{"profesor": "Francisco Agustin Vazquez Esquivel", "salon": "EE-1", "horario": [(d,8,9) for d in range(5)], "id":"INS1"}, {"profesor": "Francisco Agustin Vazquez Esquivel", "salon": "EE-1", "horario": [(d,16,17) for d in range(5)], "id":"INS2"}, {"profesor": "Cecilia Mendoza Rivas", "salon": "EE-2", "horario": [(d,11,12) for d in range(5)], "id":"INS3"}, {"profesor": "Neider Gonzalez Roblero", "salon": "EE-3", "horario": [(d,15,16) for d in range(5)], "id":"INS4"}],
    "🔩 Diseño de Elementos Mecánicos": [{"profesor": "Nestor Roberto Saavedra Camacho", "salon": "FF-1", "horario": [(d,7,8) for d in range(5)], "id":"DEM1"}, {"profesor": "Lourdes Guadalupe Adame Oviedo", "salon": "FF-2", "horario": [(d,10,11) for d in range(5)], "id":"DEM2"}, {"profesor": "Juan Antonio Guerrero Hernández", "salon": "FF-3", "horario": [(d,16,17) for d in range(5)], "id":"DEM3"}, {"profesor": "Juan Antonio Guerrero Hernández", "salon": "FF-3", "horario": [(d,18,19) for d in range(5)], "id":"DEM4"}],
    "👾 Electrónica Digital": [{"profesor": "Karina Diaz Rosas", "salon": "GG-1", "horario": [(d,10,11) for d in range(5)], "id":"EDG1"}, {"profesor": "Francisco Flores Sanmiguel", "salon": "GG-2", "horario": [(d,12,13) for d in range(5)], "id":"EDG2"}, {"profesor": "Ewald Fritsche Ramírez", "salon": "GG-3", "horario": [(d,16,17) for d in range(5)], "id":"EDG3"}, {"profesor": "Miguel Maldonado Leza", "salon": "GG-4", "horario": [(d,20,22) for d in range(5)], "id":"EDG4"}],
    "〰️ Vibraciones Mecánicas": [{"profesor": "Ruben Flores Campos", "salon": "HH-1", "horario": [(d,7,8) for d in range(5)], "id":"VM1"}, {"profesor": "Ruben Flores Campos", "salon": "HH-1", "horario": [(d,10,11) for d in range(5)], "id":"VM2"}, {"profesor": "Ruben Flores Campos", "salon": "HH-1", "horario": [(d,11,12) for d in range(5)], "id":"VM3"}, {"profesor": "Ruben Flores Campos", "salon": "HH-1", "horario": [(d,12,13) for d in range(5)], "id":"VM4"}, {"profesor": "Juan Carlos Anaya Zavaleta", "salon": "HH-2", "horario": [(d,15,16) for d in range(5)], "id":"VM5"}, {"profesor": "Luis Uriel García Bustos", "salon": "HH-3", "horario": [(d,15,16) for d in range(5)], "id":"VM6"}, {"profesor": "Luis Uriel García Bustos", "salon": "HH-3", "horario": [(d,18,19) for d in range(5)], "id":"VM7"}, {"profesor": "Erendira Guadalupe Reyna Valdes", "salon": "HH-4", "horario": [(d,19,20) for d in range(5)], "id":"VM8"}],
    "🛠️ Administración del Mantenimiento": [{"profesor": "Juan Manuel Saucedo Alonso", "salon": "II-1", "horario": [(d,8,9) for d in range(4)], "id":"ADM1"}, {"profesor": "Iván De Jesús Contreras Silva", "salon": "II-2", "horario": [(d,10,11) for d in range(4)], "id":"ADM2"}, {"profesor": "Orquidea Esmeralda Velarde Sánchez", "salon": "II-3", "horario": [(d,11,12) for d in range(4)], "id":"ADM3"}, {"profesor": "Orquidea Esmeralda Velarde Sánchez", "salon": "II-3", "horario": [(d,12,13) for d in range(4)], "id":"ADM4"}, {"profesor": "Cesar Humberto Avendaño Malacara", "salon": "II-4", "horario": [(d,19,20) for d in range(4)], "id":"ADM5"}, {"profesor": "Cesar Humberto Avendaño Malacara", "salon": "II-4", "horario": [(d,20,21) for d in range(4)], "id":"ADM6"}],
    # SEMESTRE 7
    "🏭 Manufactura Avanzada": [{"profesor": "Ana Gabriela Gomez Muñoz", "salon": "JJ-1", "horario": [(d,9,10) for d in range(5)], "id":"MA1"}, {"profesor": "Ana Gabriela Gomez Muñoz", "salon": "JJ-1", "horario": [(d,10,11) for d in range(5)], "id":"MA2"}, {"profesor": "Maria Del Socorro Marines Leal", "salon": "JJ-2", "horario": [(d,12,13) for d in range(5)], "id":"MA3"}, {"profesor": "Maria Del Socorro Marines Leal", "salon": "JJ-2", "horario": [(d,15,16) for d in range(5)], "id":"MA4"}, {"profesor": "Maria Del Socorro Marines Leal", "salon": "JJ-2", "horario": [(d,16,17) for d in range(5)], "id":"MA5"}],
    "🖥️ Diseño Asistido por Computadora": [{"profesor": "José Santos Avendaño Méndez", "salon": "KK-1", "horario": [(d,9,10) for d in range(5)], "id":"DAC1"}, {"profesor": "Ana Laura Saucedo Jimenez", "salon": "KK-2", "horario": [(d,10,11) for d in range(5)], "id":"DAC2"}, {"profesor": "Juan Carlos Anaya Zavaleta", "salon": "KK-3", "horario": [(d,16,17) for d in range(5)], "id":"DAC3"}, {"profesor": "Luis Uriel García Bustos", "salon": "KK-4", "horario": [(d,19,20) for d in range(5)], "id":"DAC4"}, {"profesor": "Luis Uriel García Bustos", "salon": "KK-4", "horario": [(d,20,21) for d in range(5)], "id":"DAC5"}],
    "🔄 Dinámica de Sistemas": [{"profesor": "Karla Ivonne Fernandez Ramirez", "salon": "LL-1", "horario": [(d,11,12) for d in range(5)], "id":"DSYS1"}, {"profesor": "Gerardo Jarquín Hernández", "salon": "LL-2", "horario": [(d,13,14) for d in range(5)], "id":"DSYS2"}],
    "🌬️ Circuitos Hidráulicos y Neumáticos": [{"profesor": "Luis Rey Santos Saucedo", "salon": "MM-1", "horario": [(0,13,14),(1,13,14),(2,13,14),(3,13,14),(4,13,15)], "id":"CHN1"}, {"profesor": "Luis Rey Santos Saucedo", "salon": "MM-1", "horario": [(0,17,18),(1,17,18),(2,17,18),(3,17,18),(4,16,18)], "id":"CHN2"}, {"profesor": "Cecilia Mendoza Rivas", "salon": "MM-2", "horario": [(0,14,15),(1,14,15),(2,14,15),(3,14,15),(4,14,16)], "id":"CHN3"}, {"profesor": "Manuel Enrique Sandoval Lopez", "salon": "MM-3", "horario": [(0,18,19),(1,18,19),(2,18,19),(3,18,19),(4,17,19)], "id":"CHN4"}],
    "🔧 Mantenimiento": [{"profesor": "Jose Maria Resendiz Vielma", "salon": "NN-1", "horario": [(d,15,16) for d in range(5)], "id":"MANT1"}, {"profesor": "Jose Maria Resendiz Vielma", "salon": "NN-1", "horario": [(d,16,17) for d in range(5)], "id":"MANT2"}, {"profesor": "Luis Gerardo Sanchez Chavez", "salon": "NN-2", "horario": [(d,16,17) for d in range(5)], "id":"MANT3"}, {"profesor": "Luis Gerardo Sanchez Chavez", "salon": "NN-2", "horario": [(d,18,19) for d in range(5)], "id":"MANT4"}, {"profesor": "Luis Gerardo Sanchez Chavez", "salon": "NN-2", "horario": [(d,19,20) for d in range(5)], "id":"MANT5"}, {"profesor": "Francisco Jesus Ramos Garcia", "salon": "NN-3", "horario": [(d,17,18) for d in range(5)], "id":"MANT6"}, {"profesor": "Pedro Celedonio Lopez Lara", "salon": "NN-4", "horario": [(d,20,21) for d in range(5)], "id":"MANT7"}],
    "💾 Microcontroladores": [{"profesor": "Pedro Quintanilla Contreras", "salon": "OO-1", "horario": [(d,11,12) for d in range(5)], "id":"MICRO1"}, {"profesor": "Jozef Jesus Reyes Reyna", "salon": "OO-2", "horario": [(d,17,18) for d in range(5)], "id":"MICRO2"}],
    # SEMESTRE 8
    "📈 Formulación y Evaluación de Proyectos": [{"profesor": "Jose Ignacio Gonzalez Delgado", "salon": "PP-1", "horario": [(0,7,8),(1,7,8),(2,7,8)], "id":"FEP1"}, {"profesor": "Jose Ignacio Gonzalez Delgado", "salon": "PP-1", "horario": [(0,10,11),(1,10,11),(2,10,11)], "id":"FEP2"}, {"profesor": "Jose Ignacio Gonzalez Delgado", "salon": "PP-1", "horario": [(0,19,20),(1,19,20),(2,19,20)], "id":"FEP3"}, {"profesor": "Nadia Patricia Ramirez Santillan", "salon": "PP-2", "horario": [(0,8,9),(1,8,9),(2,8,9)], "id":"FEP4"}, {"profesor": "Perla Magdalena Garcia Her", "salon": "PP-3", "horario": [(0,11,12),(1,11,12),(2,11,12)], "id":"FEP5"}, {"profesor": "Jackeline Elizabeth Fernandez Flores", "salon": "PP-4", "horario": [(0,18,19),(1,18,19),(2,18,19)], "id":"FEP6"}],
    "🎛️ Controladores Lógicos Programables": [{"profesor": "Ana Gabriela Gomez Muñoz", "salon": "QQ-1", "horario": [(d,8,9) for d in range(5)], "id":"PLC1"}, {"profesor": "Ana Gabriela Gomez Muñoz", "salon": "QQ-1", "horario": [(d,11,12) for d in range(5)], "id":"PLC2"}],
